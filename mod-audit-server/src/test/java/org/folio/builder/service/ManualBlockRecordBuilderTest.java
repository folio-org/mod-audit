...
import static org.folio.utils.TenantApiTestUtil.MANUAL_BLOCK_CREATED_PAYLOAD_JSON;
import static org.folio.utils.TenantApiTestUtil.MANUAL_BLOCK_DELETED_PAYLOAD_JSON;
import static org.folio.utils.TenantApiTestUtil.MANUAL_BLOCK_UPDATED_PAYLOAD_JSON;
...
public class ManualBlockRecordBuilderTest extends BuilderTestBase {
  ...
  private static final String EXPECTED_CREATE_DESCRIPTION = "Block actions: borrowing, renewals, requests. Description: Manual Block Description. Staff only information: Staff information. Message to patron: Message To Patron. Expiration date: 2021-05-01.";
  ...
  private static final String EXPECTED_DELETE_DESCRIPTION = "Block actions: borrowing, requests. Description: Manual Block Description. Message to patron: Message To Patron. Expiration date: 2021-04-23.";
