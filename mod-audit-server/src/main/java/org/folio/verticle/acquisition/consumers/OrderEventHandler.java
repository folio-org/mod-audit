...
public class OrderEventHandler implements AsyncRecordHandler<String, String> {

  private static final Logger LOGGER = LogManager.getLogger();

  private final Vertx vertx;

  public OrderEventHandler(@Autowired Vertx vertx) {
    this.vertx = vertx;
  }

  @Override
  public Future<String> handle(KafkaConsumerRecord<String, String> record) {
    LOGGER.debug("OrderEventHandler :: handle");
