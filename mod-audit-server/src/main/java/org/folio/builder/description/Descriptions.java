...
public class Descriptions {
  ...
  public static final String FEE_FINE_REFUND_MSG = "Fee/Fine type: %s. Amount: %.2f. Balance: %.2f. Refund reason: %s. Additional information to staff: %s. Additional information to patron: %s.";
  public static final String FEE_FINE_TRANSFERRED_MSG = "Fee/Fine type: %s. Amount: %.2f. Balance: %.2f. Transfer account: %s. Additional information to staff: %s. Additional information to patron: %s.";
