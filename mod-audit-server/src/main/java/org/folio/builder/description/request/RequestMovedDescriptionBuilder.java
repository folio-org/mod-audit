...
public class RequestMovedDescriptionBuilder implements DescriptionBuilder {
  ...
  public String buildDescription(JsonObject original, JsonObject updated) {
    ...
    Optional.ofNullable(getProperty(updated, NEW_REQUEST_STATUS))
      .ifPresent(newRequestStatus -> description.append("New item: ").append(newRequestStatus).append(" "));
